module github.com/hashicorp/terraform-provider-guku
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/cognitoidentityprovider v1.20.1 // indirect
...
require (
	...
	github.com/devopzilla/guku-client-go v0.0.0-20220924172206-b240a9ccb52a
